...
$(function() {
    function MQTTPublishViewModel(parameters) {
		...
		self.addTopic = function(data) {
			self.settingsViewModel.settings.plugins.mqttpublish.topics.push({'topic':ko.observable(''),'publishcommand':ko.observable(''),'label':ko.observable(''),'icon':ko.observable(''),'confirm':ko.observable(false),'retained':ko.observable(false)});
		};
